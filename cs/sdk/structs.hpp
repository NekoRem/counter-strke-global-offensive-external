	...
	namespace sdk
	{
		namespace structs
		{
			...
			struct mstudiohitboxset_t {
				...
				inline mstudiobbox_t get_hitbox(int index) const {
					//return (mstudiobbox_t*)(((byte*)this) + m_hitbox_id) + index;
					return memory::read<mstudiobbox_t>((uintptr_t)(this + m_hitbox_id) + index);
				};
			};

			enum e_hitbox : std::size_t
			{
				Hitbox_Head,
				Hitbox_Neck,
				Hitbox_Pelvis,
			...
			struct studiohdr_t {
				...
				int    m_length;				// 0x004C
				vector m_eye_pos;				// 0x0050
				vector m_illum_pos;				// 0x005C
				vector m_hull_mins;				// 0x0068
				vector m_hull_maxs;             // 0x0074
				vector m_view_mins;             // 0x0080
				vector m_view_maxs;             // 0x008C
				int    m_flags;					// 0x0098
				...
				inline mstudiobone_t get_bone(int index) const {
					//return (mstudiobone_t*)(((byte*)this) + m_bone_id) + index;
					return memory::read<mstudiobone_t>((uintptr_t)(this + m_bone_id) + index);
				}

				inline mstudiohitboxset_t get_hitbox_set(int index) const {
					//return (mstudiohitboxset_t*)(((byte*)this) + m_set_id) + index;
					return memory::read<mstudiohitboxset_t>((uintptr_t)(this + m_set_id) + index);
				}
			};
			...
			{ sdk::structs::WEAPON_KNIFE, { "knife", "models/weapons/v_knife_default_ct.mdl", "knife_default_ct" } },
			{ sdk::structs::WEAPON_KNIFE_T, { "knife", "models/weapons/v_knife_default_t.mdl", "knife_t" } },
